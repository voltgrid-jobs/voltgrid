...
const TRADE_SLUG = 'electrician-jobs'
const TRADE_CATEGORY = 'electrical'
const TRADE_NAME = 'Data Center Electrician Jobs'
const TRADE_SHORT_NAME = 'Electrician'
const TRADE_ICON = '⚡'
const TRADE_BLURB = 'Journeymen, master electricians, and apprentices wiring the most power-dense buildings ever constructed.'
const TRADE_SEO_BLURB = 'Hyperscale data centers and AI training facilities run on massive electrical infrastructure — each facility can draw 100MW or more. Electricians with data center experience command premium wages, and demand is outpacing supply as construction pipelines extend years ahead. Find high-voltage, switchgear, generator, and UPS installation roles here.'
const TRADE_META_DESCRIPTION = 'Electrician jobs at data centers and AI infrastructure sites. High-voltage, switchgear, UPS, and generator roles at hyperscale facilities. Browse and apply free.'
