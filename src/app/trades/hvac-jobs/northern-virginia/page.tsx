...
const TRADE_SLUG = 'hvac-jobs'
const TRADE_CATEGORY = 'hvac'
const TRADE_NAME = 'Data Center HVAC & Mechanical Jobs'
const TRADE_SHORT_NAME = 'HVAC'
const TRADE_ICON = '❄️'
const TRADE_BLURB = 'HVAC technicians and mechanical engineers keeping data centers cool under massive thermal loads.'
const TRADE_SEO_BLURB = 'Data centers are among the most demanding HVAC environments in existence — precision cooling, chilled water systems, CRAC units, and adiabatic cooling at industrial scale. Mechanical technicians with critical facilities experience are among the most in-demand tradespeople in construction right now.'
const TRADE_META_DESCRIPTION = 'HVAC and mechanical jobs at data centers. Cooling systems, chilled water, CRAC units, and precision cooling roles at hyperscale and colocation facilities.'

const LOCATION_SLUG = 'northern-virginia'
const LOCATION_NAME = 'Northern Virginia'
